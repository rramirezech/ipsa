...
public class CatMantenimientosGen implements Serializable {
    ...
    private String cod_lis_equ, cod_man, det_man, fec_man, hor_man, cod_ope, det_obs, cod_usu, nomope;

    public CatMantenimientosGen() {
    }

    public CatMantenimientosGen(String cod_lis_equ, String cod_man, String det_man, String fec_man, String hor_man, String cod_ope, String det_obs, String cod_usu, String nomope) {
        this.cod_lis_equ = cod_lis_equ;
        this.cod_man = cod_man;
        this.det_man = det_man;
        this.fec_man = fec_man;
        this.hor_man = hor_man;
    ...
    public String getHor_man() {
        return hor_man;
    }

    public void setHor_man(String hor_man) {
        this.hor_man = hor_man;
    }
