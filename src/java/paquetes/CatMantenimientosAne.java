...
public class CatMantenimientosAne implements Serializable {
    ...
    private String cod_lis_equ, cod_man, det_man, det_obs, tip_ane, rut_ane, cod_usu, nomtip;

    public CatMantenimientosAne() {
    }

    public CatMantenimientosAne(String cod_lis_equ, String cod_man, String det_man, String det_obs, String tip_ane, String rut_ane, String cod_usu, String nomtip) {
